...
import com.huya.marksman.MagicActivity;
 ...
 * 按钮:                                                           STEP3~1 逐渐显示出来
 */
public class EntryAnimActivity extends MagicActivity {
    public static final float STEP1 = 0.12f;
    public static final float STEP2 = 0.3f;
    public static final float STEP3 = 0.8f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setPageBackground(R.color.white_ffffff);
        setPageContentBg(R.color.white_ffffff);
        hidePageTitleBar();
    ...
    private void initViews() {
        ...
        mBtnEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(EntryAnimActivity.this, MainActivity.class));
