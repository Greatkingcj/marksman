...
import com.huya.marksman.widget.gles.GLSphere;
import com.huya.marksman.widget.gles.GLSphereProgram;
import com.huya.marksman.widget.gles.GLTexture;
...
public class PanoRenderer implements GLSurfaceView.Renderer{
    ...
    private void loadTextureBitmap() {
        ...
        try {
            textureBitmap = BitmapFactory.decodeStream(MarkApplication.getApplication().getAssets().open("test1.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
