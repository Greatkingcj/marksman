...
import com.huya.marksman.opengl.object.StarryGenerator;
import com.huya.marksman.opengl.object.StarrySystem;
import com.huya.marksman.opengl.programs.StarryProgram;
...
public class StarryRenderer implements GLSurfaceView.Renderer{
    ...
    public StarryProgram starryProgram;
    ...
    private StarrySystem starrySystem;
    ...
    public StarryRenderer(GLSurfaceView glSurfaceView, Context context) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        starryProgram = new StarryProgram(context);
        programHandle = starryProgram.getProgram();
    }
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        mExecutor.execute(new StarryGenerator(this));
    }
    ...
    public void logFrame() {
        ...
        if(timePassed >= 10_000) {
            Timber.d("fps %d @ %d stars || %f", frames / 10, StarrySystem.PARTICLE_COUNT, mTime);
            frames = 0;
    ...
    public StarrySystem getStarrySystem() {
        return starrySystem;
    }

    public void setStarrySystem(final StarrySystem starrySystem) {
        this.starrySystem = starrySystem;
    }
