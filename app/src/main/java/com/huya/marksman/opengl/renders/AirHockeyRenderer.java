...
import com.huya.marksman.opengl.programs.TextureShaderProgram;
import com.huya.marksman.util.openglutil.Geometry;
import com.huya.marksman.util.openglutil.Geometry.Point;
import com.huya.marksman.util.openglutil.TextureHelper;
import com.huya.marksman.opengl.object.Mallet;
import com.huya.marksman.opengl.object.Puck;
import com.huya.marksman.opengl.object.Table;
...
public class AirHockeyRenderer implements GLSurfaceView.Renderer{
    ...
    public void handleTouchPress(float normalizedX, float normalizedY) {
        ...
        Log.d(TAG, "normalizedX: " + normalizedX + "normalizedY: " + normalizedY + "malletPressed: " + malletPressed);
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        textureBg = TextureHelper.loadTexture(context, R.drawable.homepage_bg);
    }
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        textureProgram.setUniforms(modelViewProjectionMatrix, texture, textureBg);
