 ...
 */
public class StarrySystem implements Renderable{
    ...
    public StarrySystem(StarryRenderer renderer, FloatBuffer vertexBuffer) {
        ...
        glBufferData(GL_ARRAY_BUFFER, vertexBuffer.capacity() * Constants.BYTES_PER_FLOAT, vertexBuffer, GL_STATIC_DRAW);
    ...
    @Override
    public void render() {
        final int stride = Constants.BYTES_PER_FLOAT
        ...
        GLES20.glVertexAttribPointer(mRenderer.textureCoordinateHandle,
                ...
                false,
                stride,
                Constants.BYTES_PER_FLOAT * (POS_DATA_SIZE)
        );
        ...
        GLES20.glVertexAttribPointer(mRenderer.miscHandle,
                ...
                false,
                stride,
                Constants.BYTES_PER_FLOAT * (POS_DATA_SIZE + TEXTURE_COORDS_DATA_SIZE)
        );
