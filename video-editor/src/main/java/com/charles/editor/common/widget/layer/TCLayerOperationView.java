package com.charles.editor.common.widget.layer;
...
public class TCLayerOperationView extends View {
    ...
    public TCLayerOperationView(Context context, AttributeSet attrs) {
    ...
    public TCLayerOperationView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        frameWidth = mTypedArray.getDimensionPixelSize(R.styleable.TCLayerOperationView_frameWidth, frameWidth);
        frameColor = mTypedArray.getColor(R.styleable.TCLayerOperationView_frameColor, DEFAULT_FRAME_COLOR);
        mScale = mTypedArray.getFloat(R.styleable.TCLayerOperationView_scale, DEFAULT_SCALE);
        mDegree = mTypedArray.getFloat(R.styleable.TCLayerOperationView_degree, DEFAULT_DEGREE);
        mControlDrawable = mTypedArray.getDrawable(R.styleable.TCLayerOperationView_controlDrawable);
        mControlLocation = mTypedArray.getInt(R.styleable.TCLayerOperationView_controlLocation, RIGHT_BOTTOM);

        mEditDrawble = mTypedArray.getDrawable(R.styleable.TCLayerOperationView_editDrawable);
        mEditLocation = mTypedArray.getInt(R.styleable.TCLayerOperationView_editLocation, RIGHT_TOP);

        mDeleteDrawable = mTypedArray.getDrawable(R.styleable.TCLayerOperationView_deleteDrawable);
        mDeleteLocatoin = mTypedArray.getInt(R.styleable.TCLayerOperationView_deleteLocation, LEFT_TOP);

        isEditable = mTypedArray.getBoolean(R.styleable.TCLayerOperationView_editable, DEFAULT_EDITABLE);
