...
public class MagicHudsonFilter extends GPUImageFilter {
    ...
    protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(BaseApp.application(), "filter/hudsonbackground.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(BaseApp.application(), "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(BaseApp.application(), "filter/hudsonmap.png");
		    }
	    });
	}
}
