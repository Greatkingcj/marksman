...
public class MagicHefeFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(BaseApp.application(), "filter/edgeburn.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(BaseApp.application(), "filter/hefemap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(BaseApp.application(), "filter/hefemetal.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(BaseApp.application(), "filter/hefesoftlight.png");
		    }
	    });
	}
}
