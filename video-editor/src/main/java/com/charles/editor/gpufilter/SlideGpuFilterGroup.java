package com.charles.editor.gpufilter;
...
import com.charles.editor.gpufilter.helper.MagicFilterFactory;
import com.charles.editor.gpufilter.helper.MagicFilterType;
import com.charles.editor.utils.EasyGlUtils;
import com.charles.editor.utils.ScreenUtils;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(BaseApp.application());
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                locked = true;
                downX = -1;
                if (offset > ScreenUtils.getScreenWidth(BaseApp.application()) / 3) {
                    scroller.startScroll(offset, 0, ScreenUtils.getScreenWidth(BaseApp.application()) - offset, 0, 100 * (1 - offset / ScreenUtils.getScreenWidth(BaseApp.application())));
                    needSwitch = true;
                } else {
                    scroller.startScroll(offset, 0, -offset, 0, 100 * (offset / ScreenUtils.getScreenWidth(BaseApp.application())));
                    needSwitch = false;
                }
                break;
            default:
