...
import com.charles.ijkplayer.controller.AbsPlayerController;
import com.charles.ijkplayer.proxy.ProxyManager;
import com.charles.ijkplayer.proxy.VideoPlayerManager;
import com.charles.ijkplayer.media.FileMediaDataSource;
import com.charles.ijkplayer.view.renderview.IRenderView;
import com.charles.ijkplayer.view.renderview.SurfaceRenderView;
import com.charles.ijkplayer.view.renderview.TextureRenderView;
...
public class HuyaVideoView extends FrameLayout implements BaseVideoPlayer {
    ...
    public void setVideoPath(String path) {
        //开启缓存
        mUrl = path;
        proxy = ProxyManager.getProxy(mContext);
